...
class ItemService{
  ...
  static final ItemService _itemService=ItemService._internal(); //하나의 instance만 생성해주기 위해서는 이렇게 해줘야한다
  ...
  Future<ItemModel> getItem(String itemKey)async{ //firebase에서 userModel 가져오기
    DocumentReference<Map<String,dynamic>> documentReference=FirebaseFirestore.instance.collection(COL_ITEMS).doc(itemKey);
  ...
  Future<List<ItemModel>> getItems() async{ //document가 아니라 collection을 가져오는것
